...
for variant in tqdm(variant_indices):
    ...
    try:
      ...
      with open(f"collated_markowitz_results/metrics_c{couple}_s{setting}_a{alpha_ind}_g{gamma_indexer}.csv", "at") as file:
...
for variant in tqdm(variant_indices):
    ...
    try:
      ...
      with open(f"collated_markowitz_results/vanilla_metrics_c{couple}_s{setting}_a{alpha_ind}_g{gamma_indexer}.csv", "at") as file:
...
for variant in tqdm(variant_indices):
    ...
    try:
      ...
      with open(f"collated_markowitz_results/histogram_c{couple}_s{setting}_a{alpha_ind}_g{gamma_indexer}.csv", "at") as file:
