...
for variant in range(54):
    ...
    count_data = pd.read_csv(f'results/counts_v{variant}.csv', header=None).to_numpy().astype('float')
    if len(count_data) == 0:
    ...
    vanilla_count_data = pd.read_csv(f'results/vanilla_counts_v{variant}.csv', header=None).to_numpy().astype('float')
    ...
    metrics_data = pd.read_csv(f'results/metrics_v{variant}.csv', header=None).to_numpy().astype('float')
    vanilla_metrics_data = pd.read_csv(f'results/vanilla_metrics_v{variant}.csv', header=None).to_numpy().astype('float')
    ...
    pi0s = pd.read_csv(f'results/pi0s_v{variant}.csv', header=None).to_numpy().astype('float')
    conditional_pi0s = pd.read_csv(f'results/conditional_pi0s_v{variant}.csv', header=None).to_numpy().astype('float')
...
for ml_alg_ind in range(3):
    ...
    diversity_dfR.to_csv(f'./csvs_to_plot/diversity_results_R_{ml_alg_ind}.csv')
...
for ml_alg_ind in range(3):
    ...
    df.to_csv(f'./csvs_to_plot/cluster_results_R_{ml_alg_ind}.csv')
    df_lines.to_csv(f'./csvs_to_plot/line_results_R_{ml_alg_ind}.csv')
###################################################################################################
for ml_alg_ind in range(3):
    mt_metricR = []
    ...
    mt_metric_dfR.to_csv(f'./csvs_to_plot/mt_metric_results_R_{ml_alg_ind}.csv')
###################################################################################################
for ml_alg_ind in range(3):
    mt_metricR = []
    cluster_fdp_tdp_numrR = []
    ...
    num_rejects_dfR.to_csv(f'./csvs_to_plot/num_rejects_results_R_{ml_alg_ind}.csv')
###################################################################################################
timeR = []
timeLabelR = []
methodR = []
...
time_dfR.to_csv('./csvs_to_plot/time_R.csv')
###################################################################################################
pi0R = []
sim_settingR = []
labelR = []
...
pi0_dfR.to_csv('./csvs_to_plot/pi0_results_R.csv')
###################################################################################################
pi0cR = []
clusterR = []
sim_settingR = []
...
pi0c_dfR.to_csv('./csvs_to_plot/pi0c_results_R.csv')