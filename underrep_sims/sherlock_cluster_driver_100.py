...
for job in range(250):
  ...
  with open(f"results_100/counts_v{variant}.csv", "at") as file:
      file.write(",".join(map(str, counts)) + "\n")

  with open(f"results_100/vanilla_counts_v{variant}.csv", "at") as file:
      file.write(",".join(map(str, vanilla_counts)) + "\n")

  with open(f"results_100/metrics_v{variant}.csv", "at") as file:
      file.write(",".join(map(str, metrics)) + "\n")

  with open(f"results_100/vanilla_metrics_v{variant}.csv", "at") as file:
      file.write(",".join(map(str, vanilla_metrics)) + "\n")

  with open(f"results_100/pi0s_v{variant}.csv", "at") as file:
    file.write(",".join(map(str, pi_0arr)) + "\n")
  
  with open(f"results_100/conditional_pi0s_v{variant}.csv", "at") as file:
